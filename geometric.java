...
public class geometric {
    ...
    public static void main(String[] args) {
        ...
        String outputFile = "NTCIR_DATA_CONTAINER/NTCIR12_MathIR_WikiCorpus_v2.1.0/Geometric.csv";
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(inputFile));
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (formulaVector[87] || formulaVector[60] || formulaVector[126] || formulaVector[130] || formulaVector[43] || formulaVector[122] || formulaVector[117] 
                || formulaVector[118] ) {
