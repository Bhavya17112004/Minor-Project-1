...
public class Equivalence {
    ...
    public static void main(String[] args) {
        ...
        String outputFile = "NTCIR_DATA_CONTAINER/NTCIR12_MathIR_WikiCorpus_v2.1.0/Equivalence.csv";
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(inputFile));
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (formulaVector[26] || formulaVector[37] || formulaVector[40] || formulaVector[44] || formulaVector[145] || formulaVector[146] || formulaVector[101] 
                || formulaVector[143] || formulaVector[115] || formulaVector[116] || formulaVector[105] || formulaVector[38] || formulaVector[39] ) {
