...
public class ArithmeticFormulaExtractor {

    public static void main(String[] args) {
        String inputFile = "NTCIR_DATA_CONTAINER/NTCIR12_MathIR_WikiCorpus_v2.1.0/index.csv";
        String outputFile = "NTCIR_DATA_CONTAINER/NTCIR12_MathIR_WikiCorpus_v2.1.0/arithmetic.csv";
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(inputFile));
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (formulaVector[30] || formulaVector[28] || formulaVector[109] || formulaVector[124] || formulaVector[41] || formulaVector[27] || formulaVector[141] || formulaVector[120] || formulaVector[70] || formulaVector[99] ) {
