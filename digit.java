...
public class digit {
    ...
    public static void main(String[] args) {
        ...
        String outputFile = "NTCIR_DATA_CONTAINER/NTCIR12_MathIR_WikiCorpus_v2.1.0/digit.csv";
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(inputFile));
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (formulaVector[47] || formulaVector[147] || formulaVector[149] || formulaVector[88]  || formulaVector[93]) {
