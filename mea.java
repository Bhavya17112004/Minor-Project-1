...
public class mea {
    ...
    public static void main(String[] args) {
        ...
        String outputFile = "NTCIR_DATA_CONTAINER/NTCIR12_MathIR_WikiCorpus_v2.1.0/Measurement.csv";
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(inputFile));
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (formulaVector[69] || formulaVector[144] || formulaVector[60] || formulaVector[126] ) {
